...
Interactive Streamlit app for predicting industrial machine failures using the AI4I 2020 dataset.

## Files
- `app.py` — Streamlit dashboard
- `train_model.py` — Script to train & save the model
- `rf_model.pkl` — Trained Random Forest model (generated by train_model.py)
- `requirements.txt` — Python dependencies
- `ai4i2020.csv` — Dataset (you must provide this)
...
1. Push all files (including `rf_model.pkl` and `ai4i2020.csv`) to a GitHub repo
2. Go to https://share.streamlit.io → "New app"
3. Connect your GitHub repo, set main file to `app.py`
4. Click Deploy

> **Tip:** If the repo is too large due to `ai4i2020.csv`, host `rf_model.pkl` via Git LFS or run `train_model.py` as a startup script.
...
- **Recall (failures):** 76%
- **AUC-ROC:** 0.95
- **Features:** Air Temperature, Rotational Speed, Torque, Tool Wear
